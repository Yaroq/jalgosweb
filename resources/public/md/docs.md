<div class="bs-callout bs-callout-danger">
 ...
 <ol>
   ...
   <li> Add the connection parameters in the <code>jalgosweb.db.core</code> namespace.
...
Request middleware functions are located under the `jalgosweb.middleware` namespace.
